...
<ul>
                ...
                <li id="leftSideBarSelected"><a href="#">Reduce Surrogate  Crossover (RSX)</a></li>
    ...
    <div class="topButtons">
        <a id="btnPrev" href="shuffleCrossover.php" class="btn"> Previous</a>
        <a id="btnNext" href="averageCrossover.php" class="btn">Next</a>
    </div>
        <div class="explain">

        <h1>Reduce Surrogate Crossover (RSX)</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    This crossover takes place only if the selected parents are different in more than one Gene. 
                    This means that if the parents are similar or are different in only one Gene, 
                    this crossover won't be operated on the parents. if the value of more than one Gene is 
                    different the positions where the genes of the parents have different values are selected 
                    and one of these positions is chosen randomly and one point crossover is operated on parents in the Chosen position.
                </p>

                <p>This is an example for how it works.</p>

<img class="image-view" src="Genetics/Genetic pictures/Crossover/reduced_surrogate_crossover.png" alt="Reduce Surrogate Crossover (RSX)"/> 
<?php
    
    include 'includes/dbh.inc.php';
    $page_id = 25; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=25" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def one_point_crossover(parent_one, parent_two, x_point, pc):  <br>  
    ...
    <br>  
"Reduced surragate crossover"  <br>  
def reduced_surragate_crossover(parent_one, parent_two, pc):  <br>  
    """  <br>  
    This function takes two parents, and performs Reduced surragate crossover on them.   <br>  
    parent_one: First parent  <br>  
    parent_two: Second parent  <br>  
    pc: The probability of crossover  <br>  
    """    <br>  
    ...
    <br>  
    parent_one = Chromosome(genes= np.array([1, 1, 1, 0, 1, 0, 0, 1, 0, 0]),id_=0,fitness = 125.2)  # childs  <br>  
    parent_two = Chromosome(genes= np.array([1, 0, 0, 0, 1, 0, 1, 1, 0, 1]),id_=1,fitness = 125.2)  <br>  
    <br>  
    print("\nParents")  <br>  
    print("=================================================")      <br>  
    Chromosome.describe(parent_one)  <br>  
    ...
    <br>  
    if np.random.rand() < pc and dif>1:  # if pc is greater than random number and more that one gene is different  <br>  
        point_nums = np.random.randint(2, abs(chrom_length)) #choose number of points to be nominated for crossover points  <br>  
        points = sorted_random_numbers(point_nums,chrom_length) #choose several positions for crossover  <br>  
        pos = np.random.randint(0, point_nums) #choose the point for 1PX  <br>  
        <br>  
        print("\nParents in one_point_crossover is shown in the following")  <br>  
        print("The point for one_point_crossover:" ,points[pos])  <br>  
        print("===============================================================================")    <br>     
        child_one, child_two = one_point_crossover(parent_one,parent_two,points[pos],1) #performing one point crossover  <br>  
        print("===============================================================================")          <br>  
        <br>  
    else:  # if pc is less than random number then don't make any change  <br>  
        child_one = deepcopy(parent_one)  <br>  
...
CROSS = reduced_surragate_crossover(parent1, parent2, 1)  <br>  
<br>  
...
<br>
# Parents in one_point_crossover is shown in the following <br>
# The point for one_point_crossover: 8 <br> 
# =============================================================================== <br>
<br>
# Parents <br>
# ================================================= <br>
