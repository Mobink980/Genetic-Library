...
<ul>
                ...
                <li id="leftSideBarSelected"><a href="#">Geometrical Crossover</a></li>
    ...
    <div class="topButtons">
        <a id="btnPrev" href="directionalHeuristicCrossover.php" class="btn"> Previous</a>
        <a id="btnNext" href="simulatedBinaryCrossover.php" class="btn">Next</a>
    </div>
        <div class="explain">

        <h1>Geometrical Crossover</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    In Geometrical crossover, one offspring is produced, which the value of 
                    its genes is calculated by the geometrical average of the same genes in parents. 
                    If we have n parents, each gene of the offspring will be produced as follow:
                </p>
                <p>child-one[i] = (〖parent_one〗^(a_1 ) * 〖parent_two〗^(a_2 )* … * 〖parent_n〗^(a_n ))</p>
                <p>Which ∑_(i=1) to n (a_i) = 1;</p>
                <p>This is an example of how it works.</p>

<img class="image-view" src="Genetics/Genetic pictures/Crossover/geometrical_crossover.png" alt="Geometrical Crossover"/> 
<div class="code">
...
"Geometrical crossover"    <br>
def geometrical_crossover(parent_one, parent_two, pc):    <br>
    """    <br>
    This function takes two parents, and performs Geometrical crossover on them.    <br>
    This function, uses geometrical average to produce the childs. This crossover can also be usesd in multiparent recombination.     <br>
    ...
    <br>
        alpha1 = np.random.uniform(low=0.0, high=0.5)  # alpha1 + alpha2 = 1    <br>
        alpha2 = 1 - alpha1    <br>
        <br>
        print(alpha1 + alpha2)          <br>
        <br>
        for i in range(chrom_length):    <br>
            child_one.genes[i] = round(math.sqrt(parent_one.genes[i] * parent_two.genes[i]), 3)    <br>
            child_two.genes[i] = round((parent_one.genes[i] ** alpha1) * (parent_two.genes[i] ** alpha2), 3)    <br>
            <br>
...
CROSS = geometrical_crossover(parent1, parent2, 1)    <br>
<br>
...
# ID=#0, Fitness=125.2,    <br>
# Genes=    <br>
# [0.304 0.16  0.459 0.249 0.809 0.323 0.652 0.35 ]    <br>
# ID=#1, Fitness=125.2,    <br>
# Genes=    <br>
# [0.36  0.161 0.521 0.276 0.823 0.325 0.703 0.315]    <br>
  </div>  
</div>
