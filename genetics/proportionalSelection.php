...
<div id="leftSideBar" style="margin-top: 90px;">
        <ul>
            ...
            <li id="leftSideBarSelected"><a href="#">Proportional Selection</a></li>
    ...
    <div class="topButtons">
        ...
        <h1>Proportional Selection</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    In Proportional Selection, Each individual has the probability of fitness(x(i))/total_fitnesses, 
                    to be selected. (the selection is biased towards individuals with better fitnesses)
                </p>
  ...
  <?php
    ...
    $page_id = 12; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=12" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def fitness_function(chrom): #TODO needs to be more generalize and useful <br>
    ...
    return fitness <br>
    <br>
def proportional_selection(selection_size, pop):  <br>
    """ <br>
    In Proportional Selection, Each individual has the probability of fitness(x(i))/total_fitnesses,  <br>
    ...
    for i in range(pop_size): #calculating the probability of selection for each individual <br>
        probs[i] = round(abs(fitness_function(pop[i].genes)/total_fitnesses), 3) <br>
    print(probs) <br>
    select = random.choices(pop, probs, k = selection_size) <br>
    <br>
    return select <br>
    <br>
    <br>
...
for i in range(len(POP)): #printing the population <br>
    ...
    <br>
SELECTION = proportional_selection(5, POP) <br>
<br>
