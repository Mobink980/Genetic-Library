...
<ul>
                ...
                <li id="leftSideBarSelected"><a href="#">One-point Crossover</a></li>
    ...
    <div class="topButtons">
        ...
        <a id="btnNext" href="multiPointCrossover.php" class="btn">Next</a>
    </div>
        <div class="explain">
        ...
        <h1>One-point Crossover</h1>
                ...
                <p>
                    ...
                    are produced. One point in the parent chromosomes is selected randomly, and the genes
                    of the first half of child-one will be filled by the parent-one, and the second half
                    of the child-one will be filled by the second half of the parent-two.
                </p>
                <p>
                    The same thing will happen for child-two. The first half of child-two is filled by the 
                    first half of parent-two, and the second half of child-two is filled by the child-one.
                </p>
                <p>This is an example for how it works.</p>

<img class="image-view" src="Genetics/Genetic pictures/Crossover/one_point_crossover.png" alt="One-point Crossover"/> 
<?php
    
    include 'includes/dbh.inc.php';
    $page_id = 16; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=16" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
CROSS = one_point_crossover(parent1, parent2, 0, 1)  <br>
<br>
