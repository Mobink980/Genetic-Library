...
<ul>
                ...
                <li id="leftSideBarSelected"><a href="#">Uniform Crossover</a></li>
    ...
    <div class="topButtons">
        <a id="btnPrev" href="multiPointCrossover.php" class="btn"> Previous</a>
        <a id="btnNext" href="multiParentCrossover.php" class="btn">Next</a>
    </div>
        <div class="explain">
        ...
        <h1>Uniform Crossover</h1>
                ...
                <p>
                    In uniform crossover, a random number between 0 and 1 is produced for each 
                    gene of the parent chromosome. if that random number is less than 0.5 then 
                    the gene from parent one will be transferred to child one otherwise the Gene 
                    will come from parent two.
                </p>
                <p>
                    The same thing will happen to child two but the condition is reversed. 
                    Which means that whatever gene is transferred to child one from one of the parents, 
                    the gene from the other parent in that position is transferred to child two.
                </p>
                <p>This is an example for how it works.</p>

<img class="image-view" src="Genetics/Genetic pictures/Crossover/uniform_crossover.png" alt="Uniform Crossover"/> 
<?php
    
    include 'includes/dbh.inc.php';
    $page_id = 18; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=18" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
CROSS = uniform_crossover(parent1, parent2, 1) <br>
<br>
