...
<div id="leftSideBar" style="margin-top: 90px;">
            <ul>
                ...
                <li id="leftSideBarSelected"><a href="#">Displacement Mutation</a></li>
    ...
    <div class="topButtons">
        <a id="btnPrev" href="distanceBasedMutation.php" class="btn"> Previous</a>
        <a id="btnNext" href="insertionMutation.php" class="btn">Next</a>
    </div>
        <div class="explain">

        <h1>Displacement Mutation</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    In displacement mutation, we select a random substring from the chromosome, 
                    and paste it in another position, without changing the sequence of other elements.
                </p>
                <p>This is an example for how it works.</p>

<img class="image-view" src="Genetics/Genetic pictures/Mutation/displacement_mutation.png" alt="Displacement Mutation"/> 
<?php
    
    include 'includes/dbh.inc.php';
    $page_id = 62; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=62" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def sorted_random_numbers(point_nums, interval): <br>
    ...
    <br>
    <br>
"Displacement mutation" <br>
def displacement_mutation(parent_one, pm): <br>
    """ <br>
    This function takes one chromosome, and performs Displacement mutation on it. <br> 
...
MUTATION = displacement_mutation(parent1, 1) <br>
<br>
