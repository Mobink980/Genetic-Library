...
<div id="leftSideBar" style="margin-top: 90px;">
    ...
    <div class="right-side-panel"></div> <!--The empty space at the right of the page-->
        ...
        <hr>
<p style="margin-bottom: 40px;">You can write your essay in the field of Artificial Immune Systems in the following field.</p>
<?php
...
<div class="contribute">
    <form action="includes/AIS.inc.php" method="POST">
