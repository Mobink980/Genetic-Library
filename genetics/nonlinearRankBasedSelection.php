...
<div id="leftSideBar" style="margin-top: 90px;">
        <ul>
            ...
            <li id="leftSideBarSelected"><a href="#">Non-linear Rank-Based Selection</a></li>
    ...
    <div class="topButtons">
        ...
        <h1>Non-linear Rank-Based Selection</h1>
                <hr />
   ...
   <?php
    ...
    $page_id = 14; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=14" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def fitness_function(chrom): #TODO needs to be more generalize and useful <br>
    ...
    return fitness <br>
    <br>
def nonlinear_rank_based_selection(selection_size, pop):  <br>
    """ <br>
    ...
    normalization_constant = np.random.uniform(low=0.0, high=1.0)  <br>
    <br>
    <br>
    ...
    for i in range(pop_size): #calculating the probability of selection for each individual <br>
        probs[i] = round(abs((1 - np.exp(-ranks[i]))/normalization_constant), 3)  <br>
        <br>
...
for i in range(len(POP)): #printing the population <br>
    ...
    <br>
SELECTION = nonlinear_rank_based_selection(5, POP) <br>
<br>
