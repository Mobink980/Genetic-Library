...
<div id="leftSideBar" style="margin-top: 90px;">
            <ul>
                ...
                <li id="leftSideBarSelected"><a href="#">Swap Mutation</a></li>
    ...
    <div class="topButtons">
        <a id="btnPrev" href="randomResettingMutation.php" class="btn"> Previous</a>
        <a id="btnNext" href="scrambleMutation.php" class="btn">Next</a>
    </div>
        <div class="explain">
        ...
        <h1>Swap Mutation</h1>
                ...
                <p>
                    In swap mutation, two genes are randomly selected, 
                    and the value of those two genes is swapped.
                </p>
                <p>This is an example for how it works.</p>

<img class="image-view" src="Genetics/Genetic pictures/Mutation/swap_mutation.png" alt="Swap Mutation"/> 
<?php
    
    include 'includes/dbh.inc.php';
    $page_id = 55; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=55" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def sorted_random_numbers(point_nums, interval): <br>
    ...
    <br>
"Swap mutation" <br>
def swap_mutation(parent_one, pm): <br>
    """ <br>
    This function takes one chromosome, and performs Swap mutation on it.  <br>
    ...
    if np.random.rand() < pm:  # if pm is greater than random number <br>
        ...
        parent_one.genes[points[0]], parent_one.genes[points[1]] = parent_one.genes[points[1]], parent_one.genes[points[0]]  <br>
...
MUTATION = swap_mutation(parent1, 1) <br>
<br>
