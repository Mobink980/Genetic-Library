...
<div id="leftSideBar" style="margin-top: 90px;">
        <ul>
            ...
            <li id="leftSideBarSelected"><a href="#">Exponential Ranking  Selection</a></li>
    ...
    <div class="topButtons">
        ...
        <h1>Exponential Ranking  Selection</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Beatae odit iure deleniti tenetur facere laborum dolore iste? 
                    Debitis sequi cupiditate, facilis, magnam beatae aspernatur quisquam
                     illo, necessitatibus maxime nemo nobis?Lorem, ipsum dolor sit amet 
                     consectetur adipisicing elit. Ipsa ut corporis minus nulla totam nemo 
                     fugiat soluta. Alias accusantium repellat quisquam perspiciatis soluta
                      aliquam? Officia, quibusdam? Harum recusandae sint consequuntur?Lorem
                       ipsum dolor sit amet consectetur adipisicing elit. Ea, officia odit 
                       sequi tempora nulla pariatur facere ut distinctio vitae tenetur. Ullam 
                       id dicta tempore debitis at esse aliquid delectus nam.
                </p>


  <?php
    include 'includes/dbh.inc.php';
    $page_id = 10; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=10" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def fitness_function(chrom): #TODO needs to be more generalize and useful <br> 
    ...
    return fitness <br>
    <br>
def exponential_ranking_selection(selection_size, pop): #TODO <br>
    """ <br>
...
for i in range(len(POP)): #printing the population <br>
    ...
    <br>
SELECTION = exponential_ranking_selection(5, POP) <br>
<br>
