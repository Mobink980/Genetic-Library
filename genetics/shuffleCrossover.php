...
<ul>
                ...
                <li id="leftSideBarSelected"><a href="#">Shuffle Crossover (SX)</a></li>
    ...
    <div class="topButtons">
        <a id="btnPrev" href="heuristicCrossover.php" class="btn"> Previous</a>
        <a id="btnNext" href="reduceSurrogateCrossover.php" class="btn">Next</a>
    </div>
        <div class="explain">

        <h1>Shuffle Crossover (SX)</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    In this crossover, we select two parents from the population and two offspring are produced. 
                    We choose several random positions which are the same in both parents then we shuffle the genes 
                    in these positions in the same way in both parents. after that, we do one point crossover on the 
                    parents and finally unshuffle the genes in the offspring that we shuffled earlier.
                </p>
               
                <p>This is an example for how it works.</p>

<img class="image-view" src="Genetics/Genetic pictures/Crossover/shuffle_crossover.png" alt="Shuffle Crossover (SX)"/> 
<?php
    
    include 'includes/dbh.inc.php';
    $page_id = 24; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=24" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def one_point_crossover(parent_one, parent_two, x_point, pc):  <br>
    ...
    else:  # if pc is less than random number then dont make any change  <br>
        child_one = deepcopy(parent_one)  <br>
        child_two = deepcopy(parent_two)  <br>
        <br>
    return child_one, child_two  <br>
    <br>
"Shuffle crossover"  <br>
def shuffle_crossover(parent_one, parent_two, pc):  <br>
    """  <br>
    This function takes two parents, and performs Shuffle crossover on them.   <br>
    parent_one: First parent  <br>
    parent_two: Second parent  <br>
    pc: The probability of crossover  <br>
    """    <br>
    ...
    points = sorted_random_numbers(4,chrom_length)  <br>
    # print(points)  <br>
    <br>
    if np.random.rand() < pc:  # if pc is greater than random number  <br>
        parent_one.genes[points[0]], parent_one.genes[points[2]] = parent_one.genes[points[2]], parent_one.genes[points[0]] #shuffle the elements of p1  <br>
        parent_one.genes[points[1]], parent_one.genes[points[3]] = parent_one.genes[points[3]], parent_one.genes[points[1]]  <br>
        <br>
        parent_two.genes[points[0]], parent_two.genes[points[2]] = parent_two.genes[points[2]], parent_two.genes[points[0]] #shuffle the elements of p2 in the same way  <br>
        parent_two.genes[points[1]], parent_two.genes[points[3]] = parent_two.genes[points[3]], parent_two.genes[points[1]]  <br>
        <br>
        print("\nParents in one_point_crossover is shown in the following")  <br>
        print("===============================================================================")  <br>
        child_one, child_two = one_point_crossover(parent_one,parent_two, 0,1) #performing one point crossover  <br>
        print("===============================================================================")  <br>
        <br>
        child_one.genes[points[0]], child_one.genes[points[2]] = child_one.genes[points[2]], child_one.genes[points[0]] #reshuffle the elements of c1  <br>
        child_one.genes[points[1]], child_one.genes[points[3]] = child_one.genes[points[3]], child_one.genes[points[1]]  <br>
        <br>
        child_two.genes[points[0]], child_two.genes[points[2]] = child_two.genes[points[2]], child_two.genes[points[0]] #reshuffle the elements of c2 in the same way  <br>
        child_two.genes[points[1]], child_two.genes[points[3]] = child_two.genes[points[3]], child_two.genes[points[1]]  <br>
        <br>
...
CROSS = shuffle_crossover(parent1, parent2, 1)  <br>
<br>
...
# ID=#0, Fitness=125.2,  <br>
# Genes=  <br>
# [8 1 2 3 4 5 6 7 9 0]  <br>
# ID=#1, Fitness=125.2,  <br>
# Genes=  <br>
# [0 4 7 3 6 2 5 1 8 9]  <br>
  </div>  
</div>
