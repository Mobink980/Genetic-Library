...
<ul>
                ...
                <li id="leftSideBarSelected"><a href="#">Arithmetic Crossover</a></li>
            </ul>
    </div>
    ...
    <div class="topButtons">
        <a id="btnPrev" href="hillclimbingCrossover.php" class="btn"> Previous</a>
        <a id="btnNext" href="BitFlipMutation.php" class="btn">Next</a>
    </div>
        <div class="explain">

        <h1>Arithmetic Crossover</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                   Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                   Labore unde autem rerum, quisquam perferendis quia 
                   necessitatibus magni amet eaque odit est minima et aliquid 
                   quidem veritatis repellendus. Consequuntur, nobis natus. Lorem 
                   ipsum dolor sit amet consectetur, adipisicing elit. Eveniet rerum
                    aperiam illo consequuntur modi deserunt recusandae soluta sequi possimus, 
                    eius amet magnam. Molestias id enim quis alias, aliquid esse possimus.
                     Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi ex
                      dolorum aliquam debitis deleniti, ipsa soluta itaque porro iste
                       consequatur, voluptatum velit alias illum. Debitis corrupti pariatur
                        reprehenderit aut dignissimos.
                </p>

                <p>This is an example of how it works.</p>

<img class="image-view" src="Genetics/Genetic pictures/Crossover/arithmetic_crossover.png" alt="Binary Representation"/> 
<?php
    
    include 'includes/dbh.inc.php';
    $page_id = 52; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=52" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def arithmetic_crossover(parent_one, parent_two, pc):   <br>
    """   <br>
    This function takes two parents, and performs Arithmetic crossover on them.    <br>
    This crossover is also used in multiparent recombination.    <br>
    ...
    if np.random.rand() < pc:  # if pc is greater than random number    <br> 
        alpha = np.random.uniform(low=0.0, high=1.0)   <br>
        for i in range(chrom_length):   <br>
            child_one.genes[i] = round((1 - alpha) * parent_one.genes[i] + alpha * parent_two.genes[i], 3)   <br>
            child_two.genes[i] = round(alpha * parent_one.genes[i] + (1 - alpha) * parent_two.genes[i], 3)     <br>  
            <br>
            <br>
...
CROSS = arithmetic_crossover(parent1, parent2, 1)   <br>
<br>
...
# ID=#0, Fitness=125.2,   <br>
# Genes=   <br>
# [0.714 0.167 0.859 0.412 0.88  0.331 0.937 0.229]   <br>
# ID=#1, Fitness=125.2,   <br>
# Genes=   <br>
# [0.172 0.153 0.286 0.166 0.745 0.316 0.478 0.598]   <br>
  </div>  
</div>
