...
<div id="leftSideBar" style="margin-top: 90px;">
            <ul>
                ...
                <li id="leftSideBarSelected"><a href="#">Throas Mutation</a></li>
    ...
    <div class="topButtons">
        <a id="btnPrev" href="centerinversionMutation.php" class="btn"> Previous</a>
        <a id="btnNext" href="throrsMutation.php" class="btn">Next</a>
    </div>
        <div class="explain">

        <h1>Throas Mutation</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    In throas mutation, we select three positions in a sequence and then we do the following.
                </p>
...
<img class="image-view" src="Genetics/Genetic pictures/Mutation/throas_mutation.png" alt="Throas Mutation"/> 
<?php
    
    include 'includes/dbh.inc.php';
    $page_id = 60; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=60" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def sorted_random_numbers(point_nums, interval): <br>
    ...
    <br>
"Throas mutation" <br>
def throas_mutation(parent_one, pm): <br>
    """ <br>
    This function takes one chromosome, and performs Throas mutation on it.  <br>
    Last ==> First <br>
    Second ==> Last <br>
    First ==> Second  <br>
    ...
    if np.random.rand() < pm:  # if pm is greater than random number <br>
        interval = [] <br>
        point1 = np.random.randint(0,chrom_length-3) <br>
        point2 = point1 + 3 <br>
        child_one.genes = parent_one.genes <br>
        for i in range(point1, point2): <br>
            interval.append(child_one.genes[i]) <br>
        # print(interval) <br>
        interval_copy = interval.copy() <br>
        interval[0] = interval_copy[-1]  <br>
        interval[-1] = interval_copy[1]  <br>
        interval[1] = interval_copy[0]  <br>
        # print(interval) <br>
        k = 0 <br>
        for i in range(point1, point2): <br>
...
MUTATION = throas_mutation(parent1, 1) <br>
<br>
