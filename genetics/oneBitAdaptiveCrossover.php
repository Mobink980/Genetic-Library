...
<ul>
                ...
                <li id="leftSideBarSelected"><a href="#">1-bit Adaptive Crossover (1BX)</a></li>
    ...
    <div class="topButtons">
        <a id="btnPrev" href="maskedCrossover.php" class="btn"> Previous</a>
        <a id="btnNext" href="modifiedPartiallyMappedCrossover.php" class="btn">Next</a>
    </div>
        <div class="explain">

        <h1>1-bit Adaptive Crossover (1BX)</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    In 1-bit adaptive crossover, we look at the value of the last genes in two parents.
                </p>
                <p>1. if the last two bits in the parents were the same and equal to 0 then we perform uniform crossover on the parents.</p>
                <p>2. if the last two bits in the parents were the same and equal to 1 then we perform two-point crossover under parents.</p>
                <p>
                    3. if the last two bits in the parents were different, we create a uniform random real number w to choose
                    which crossover to perform.
                </p>
                <ul>
                    <li>if w is less than 0.5, then we perform uniform crossover.</li>
                    <li>otherwise we perform two-point crossover.</li>
                </ul>
                                                                                   
                <p>This is an example for how it works.</p>

<img class="image-view" src="Genetics/Genetic pictures/Crossover/one_bit_adaptive_crossover.png" alt="1-bit Adaptive Crossover (1BX)"/> 
<?php
    
    include 'includes/dbh.inc.php';
    $page_id = 65; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=65" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def uniform_crossover(parent_one, parent_two, pc):  <br>
    ...
    return child_one, child_two  <br>
    <br>
"1_Bit adaptive crossover"  <br>
def one_bit_adaptive_crossover(parent_one, parent_two, pc):  <br>
    """  <br>
    This function takes two parents, and performs 1_Bit adaptive crossover on them.   <br>
    The last gene of two parents are the same and both zero ==> Uniform crossover  <br>
    The last gene of two parents are the same and both one ==> Multi-point crossover    <br>
    parent_one: First parent  <br>
    parent_two: Second parent  <br>
    pc: The probability of crossover  <br>
    """    <br>
    ...
    parent_two = Chromosome(genes= np.array([1, 0, 1, 1, 1, 0, 1, 1, 1, 1]),id_=1,fitness = 125.2)  <br>
    <br>
    print("\nParents")  <br>
    print("=================================================")  <br>
    Chromosome.describe(parent_one)  <br>
    ...
    if np.random.rand() < pc:  # if pc is greater than random number  <br>
    <br>
        if parent_one.genes[-1] == 0 and parent_two.genes[-1] == 0:  <br>
            child_one, child_two = uniform_crossover(parent_one,parent_two,1)  <br>
        elif parent_one.genes[-1] == 1 and parent_two.genes[-1] == 1:  <br>
            child_one, child_two = multi_point_crossover(parent_one,parent_two,1)   <br>
        else:  <br>
            w = np.random.uniform(low=0, high=1)  <br>
            if w < 0.5:  <br>
                child_one, child_two = uniform_crossover(parent_one,parent_two,1)  <br>
            else:  <br>
                child_one, child_two = multi_point_crossover(parent_one,parent_two,1)   <br>
...
CROSS = one_bit_adaptive_crossover(parent1, parent2, 1)  <br>
<br>
if __name__ == '__main__':  <br>
    print("\nChildren")  <br>
    print("=================================================")  <br>
    for index, _ in enumerate(CROSS):  #two children  <br>
