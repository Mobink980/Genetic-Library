...
<div id="leftSideBar" style="margin-top: 90px;">
        <ul>
            ...
            <li id="leftSideBarSelected"><a href="#">Linear Rank-Based Selection</a></li>
    ...
    <div class="topButtons">
        ...
        <h1>Linear Rank-Based Selection</h1>
                <hr />
                ...
                <p>
                    ...
                    Selection is independent of absolute fitness. The individual with the rank one is the worst.
                </p>
    ...
    $page_id = 13; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=13" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def fitness_function(chrom): #TODO needs to be more generalize and useful  <br>
    ...
    return fitness  <br>
    <br>
def linear_rank_based_selection(selection_size, pop):   <br>
    """  <br>
    Rank-based Selection, uses the rank ordering of fitness values to determine the probability of selection.  <br>
    Selection is independent of absolute fitness. The individual with the rank one is the worst.  <br>
    ...
    select = []  <br>
    sorted_pop = pop_sort(pop)  <br>
    worst_individual_offsprings = np.random.randint(0, 3) #Number of offsprings for the worst individual based on fitness  <br>
    best_individual_offsprings = np.random.randint(worst_individual_offsprings + 1, 4) #Number of offsprings for the best individual based on fitness  <br>
    <br>
    for i in range(pop_size): #calculating the ranks: the larger the rank, the better the individual  <br>
        ranks.append(i + 1)  <br>
        <br>
    for i in range(pop_size): #calculating the probability of selection for each individual  <br>
        probs[i] = round(abs((worst_individual_offsprings + abs(ranks[i]/(pop_size - 1)*(best_individual_offsprings - worst_individual_offsprings)))/pop_size), 3)   <br>
        <br>
    # for i in range(pop_size):  <br>
    #     Chromosome.describe(sorted_pop[i])  <br>
    #     print(ranks[i])  <br>
    #     print(probs[i])  <br>
    <br>
    select = random.choices(sorted_pop, probs, k = selection_size)  <br>
    <br>
    return select  <br>
    <br>
    <br>
...
for i in range(len(POP)): #printing the population  <br>
    ...
    <br>
SELECTION = linear_rank_based_selection(5, POP)  <br>
<br>
