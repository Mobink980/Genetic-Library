...
<div id="leftSideBar" style="margin-top: 90px;">
        <ul>
            ...
            <li id="leftSideBarSelected"><a href="#">Self-Adaptive Tournament Selection</a></li>
    ...
    <div class="topButtons">
        ...
        <h1>Self-Adaptive Tournament Selection</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                     Facilis minima est nostrum magni inventore illo aperiam 
                     error adipisci totam sequi alias voluptas assumenda incidunt
                      atque tempore eligendi earum, necessitatibus dolores. Lorem 
                      ipsum dolor sit amet consectetur adipisicing elit. Amet rem
                       dolores nostrum quam doloremque eligendi nulla eos nesciunt
                        ut debitis eius, accusamus magni dolor? Veritatis quia 
                        soluta ex minima voluptates?
                </p>

 <?php
    
    include 'includes/dbh.inc.php';
    $page_id = 11; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=11" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def fitness_function(chrom): #TODO needs to be more generalize and useful <br>
    ...
    return fitness <br>
    <br>
def self_adaptive_tournament_selection(selection_size, pop): #TODO <br>
    """ <br>
...
for i in range(len(POP)): #printing the population <br>
    ...
    <br>
SELECTION = self_adaptive_tournament_selection(5, POP) <br>
<br>
