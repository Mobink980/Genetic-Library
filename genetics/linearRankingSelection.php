...
<div id="leftSideBar" style="margin-top: 90px;">
        <ul>
            ...
            <li id="leftSideBarSelected"><a href="#">Linear Ranking Selection</a></li>
    ...
    <div class="topButtons">
        ...
        <h1>Linear Ranking  Selection</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                    Sequi hic, minus, possimus dolorum id vel in dolorem repellendus
                     amet magni aliquid. Accusamus, quis suscipit asperiores odit quo 
                     eaque expedita cum! Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                     Rem ab iure voluptatibus quaerat praesentium quae, velit autem. Est delectus 
                     atque veniam quibusdam neque? Quo mollitia cupiditate et ad qui? Eaque?
                </p>

                <?php
    
    include 'includes/dbh.inc.php';
    $page_id = 9; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=9" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def pop_sort(pop): <br>
    ...
    <br>
    <br>
def linear_ranking_selection(selection_size, pop): #TODO <br>
    """ <br>
...
for i in range(len(POP)): #printing the population <br>
    ...
    <br>
SELECTION = linear_ranking_selection(5, POP) <br>
<br>
