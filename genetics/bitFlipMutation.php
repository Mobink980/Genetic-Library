...
<div id="leftSideBar" style="margin-top: 90px;">
            <ul>
                ...
                <li id="leftSideBarSelected"><a href="#">Bit Flip Mutation</a></li>
    ...
    <div class="topButtons">
        ...
        <a id="btnNext" href="randomResettingMutation.php" class="btn">Next</a>
    </div>
        <div class="explain">

        <h1>Bit Flip Mutation</h1>
                <hr />
                <!--explanation needs fixing-->
                <p>
                    In bit-flip mutation, one or several positions are randomly selected, 
                    and their values are flipped. In other words, in the selected positions,
                    if the value of the gene is 1, it will become 0; and if the value of the
                    gene is 0, it will become 1.
                </p>
                <p>This is an example for how it works.</p>

<img class="image-view" src="Genetics/Genetic pictures/Mutation/bit_flip_mutation.png" alt="Bit Flip Mutation"/> 
<?php
    
    include 'includes/dbh.inc.php';
    $page_id = 53; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=53" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def bit_flip_mutation(parent_one, pm):  <br>
    """  <br>
    This function takes one chromosome, and performs Bit flip mutation on it.   <br>
    parent_one: The parent  <br>  
    pm: The probability of mutation  <br>
    """   <br>
    parent_one = Chromosome(genes= np.array([1, 1, 1, 0, 1, 0, 0, 1, 0]),id_=0,fitness = 125.2) #parent  <br>
    print("\nParent")  <br>
    print("=================================================")  <br>
    ...
    if np.random.rand() < pm:  # if pm is greater than random number  <br>
        point_nums = np.random.randint(1, 4)  <br>
        points = sorted_random_numbers(point_nums, chrom_length)  <br>
        print("points:", points)  <br>
        <br>
        for i in range(point_nums): #performing XOR, to flip the bits in the chosen points  <br>
            parent_one.genes[points[i]] = parent_one.genes[points[i]] ^ 1  <br>
...
MUTATION = bit_flip_mutation(parent1, 1)  <br>
<br>
...
Genes= <br>
[5 3 3 2 3 9 7 6 5] <br>
ID=#1, Fitness=125.2, <br>
Genes= <br>
[5 4 7 6 5 2 6 1 3] <br>
<br>
Children <br>
================================================= <br>
ID=#0, Fitness=125.2, <br>
Genes= <br>
[5 3 5 4 4 5 6 3 4] <br>
  </div>  
</div>
