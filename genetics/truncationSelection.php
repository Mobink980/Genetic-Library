...
<div id="leftSideBar" style="margin-top: 90px;">
        <ul>
            ...
            <li id="leftSideBarSelected"><a href="#">Truncation Selection</a></li>
    ...
    <div class="topButtons">
        ...
        <h1>Truncation Selection</h1>
                <hr />
                <p>
                    In Truncation Selection, Only the fittest members of the population 
                    will be selected and these individuals will be duplicated to maintain the population. 
                    Truncation selection has the greatest selection pressure.
                </p>

   <?php
    
    include 'includes/dbh.inc.php';
    $page_id = 5; //get the page_id from the url
    $sql = "SELECT * FROM search WHERE page_id= '$page_id'";           
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $number = $row['page_like'];
    echo '<a href="increaseLike.php?pageid=5" class="btn btn-success" id ="like"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id = "num">'.$number.'</span></a>'; 
      ?>
<div class="code">
...
def pop_sort(pop): <br>
    ...
    <br>
    <br>
def truncation_selection(selection_size, pop): <br>
    """ <br>
    In Truncation Selection, Only the fittest members of the population will be selected <br>
    and these individuals will be duplicated to maintain the population. <br>
    This function takes a population, and returns the fittest ones inside. <br>
    ...
    select = [] <br>
    if selection_size > pop_size: #assuring that the selection size is less than the size of the population <br>
        selection_size = pop_size <br>
    for i in range(selection_size-1,-1,-1): #backward loop <br>
        select.append(sorted_pop[i]) <br>
    return select <br>
    <br>
    <br>
POP = [] <br>
...
for i in range(len(POP)): #printing the population <br>
    ...
    <br>
SELECTION = truncation_selection(5, POP) <br> 
<br>
